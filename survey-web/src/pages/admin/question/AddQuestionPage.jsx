...
const AddQuestionPage = () => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        if (responseData && responseData.message === "saved") {
          openModal('Thành công', 'Lưu câu hỏi thành công!', false);
        } else {
          openModal('Lỗi', 'Lưu câu hỏi không thành công.', true);
        }
      } catch (error) {
  ...
  const handleCancel = () => {
    setFormData({ question: "", type: "", topicId: "" });
    setErrors({ question: "", type: "", topicId: "" });
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 bg-gray-100 relative">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
        <h2 className="text-2xl font-bold mb-4 text-gray-800 text-center">Thêm Câu Hỏi</h2>
        <div>
          <div className="mb-4">
